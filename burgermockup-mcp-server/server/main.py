...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "scene) | scene (regenerate scene; describe it in delta.change) | product (swap "
        "garment). `delta.scale` 0.3–1.6 resizes the printed design. Refines ONE image by "
        ...
        "- If the user wants a person wearing the product, a model, or any scene/location "
        "('a man wearing it', 'on the street', 'in a café'), you MUST pass "
        "scene_specs=[{'setting': '<that description>'}] — empty scene_specs renders a "
        "flat product-only image.\n"
